...
uploaded_fileF = st.sidebar.file_uploader("You shuould begin with downloading the .csv diabetes dateset given here by clicking this download button.", type=["csv"])
