...
st.sidebar.markdown("<h6>You shuould begin with downloading the .csv diabetes dateset given here by clicking this download button.</h6>", unsafe_allow_html=True)
